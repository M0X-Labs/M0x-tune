...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    ...
    >
      ...
      {/* Main card panel - Right panel */}
      <main className="flex-1 min-w-0 h-full bg-[var(--bg)] rounded-xl md:rounded-2xl border border-[var(--line)] shadow-2xl overflow-y-auto overflow-x-hidden relative z-10 p-6 md:p-8 scroll-smooth">
